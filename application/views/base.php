...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.18/b-1.5.6/b-html5-1.5.6/fc-3.2.5/fh-3.1.4/sc-2.0.0/datatables.min.css"/>
  ...
  crossorigin=""/>
		...
		<link href="<?= base_url('assets/vendors/Tokenfield/sliptree-bootstrap-tokenfield-9c06df4/dist/css/bootstrap-tokenfield.min.css') ?>" rel="stylesheet">
		<link href="<?= base_url('assets/vendors/Tokenfield/sliptree-bootstrap-tokenfield-9c06df4/dist/css/tokenfield-typeahead.min.css') ?>" rel="stylesheet">
	...
	<body>
				...
				<nav class="col-md-2 d-none d-md-block bg-light sidebar">
					<div class="sidebar-sticky">
						<ul class="nav flex-column">
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'dashboard' ? 'active' : '' ?>" href="<?= base_url() ?>">
							...
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'forms' ? 'active' : '' ?>" href="<?= base_url('forms') ?>">
							...
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'entries' || $page_name == 'form-entries' ? 'active' : '' ?>" href="<?= base_url('entries') ?>">
							...
							<?php endif; ?>
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'reports' ? 'active' : '' ?>" href="<?= base_url('reports') ?>">
									<i data-feather="file-text"></i>
									Reports
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'maps' ? 'active' : '' ?>" href="<?= base_url('maps') ?>">
						...
						<ul class="nav flex-column mb-2">
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'regions' ? 'active' : '' ?>" href="<?= base_url('regions') ?>">
									<i data-feather="settings"></i>
									Regions
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'districts' ? 'active' : '' ?>" href="<?= base_url('districts') ?>">
									<i data-feather="settings"></i>
									Districts
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'sub-counties' ? 'active' : '' ?>" href="<?= base_url('sub-counties') ?>">
									<i data-feather="settings"></i>
									Sub Counties
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'parishes' ? 'active' : '' ?>" href="<?= base_url('parishes') ?>">
									<i data-feather="settings"></i>
									Parishes
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'villages' ? 'active' : '' ?>" href="<?= base_url('villages') ?>">
									<i data-feather="settings"></i>
									Villages
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'projects' ? 'active' : '' ?>" href="<?= base_url('projects') ?>">
									<i data-feather="settings"></i>
									Projects
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'organisations' ? 'active' : '' ?>" href="<?= base_url('organisations') ?>">
									<i data-feather="settings"></i>
									Organisations
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'question-library' ? 'active' : '' ?>" href="<?= base_url('question-library') ?>">
									<i data-feather="settings"></i>
									Question Library
								</a>
							</li>
						...
						<ul class="nav flex-column mb-2">
							...
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'mobile-users' ? 'active' : '' ?>" href="<?= base_url('mobile-users') ?>">
							...
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'dashboard-users' ? 'active' : '' ?>" href="<?= base_url('dashboard-users') ?>">
							...
							<?php endif; ?>
							<li class="nav-item">
								<a class="nav-link <?= $page_name == 'settings' ? 'active' : '' ?>" href="<?= base_url('settings') ?>">
									<i data-feather="settings"></i>
									Account Settings
								</a>
							</li>
		...
		<script src="<?= base_url('assets/vendors/Bootstrap/bootstrap.js') ?>" integrity="sha384-xrRywqdh3PHs8keKZN+8zzc5TX0GRTLCcmivcbNJWm2rs5C8PRhcEn3czEjhAO9o" crossorigin="anonymous"></script>
  ...
  crossorigin=""></script>
		...
		<script type="text/javascript" src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.18/b-1.5.6/b-html5-1.5.6/fc-3.2.5/fh-3.1.4/sc-2.0.0/datatables.min.js"></script>

		<script src="<?= base_url('assets/vendors/Tokenfield/sliptree-bootstrap-tokenfield-9c06df4/dist/bootstrap-tokenfield.min.js') ?>"></script>
